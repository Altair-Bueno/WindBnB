...
<form on:submit|preventDefault={handleOnSubmit}>
  ...
  <div class="mb-3">
    ...
    <input
      type="text"
      bind:value={vivienda.description}
      name="description"
      class="form-control"
      id="description"
    />
